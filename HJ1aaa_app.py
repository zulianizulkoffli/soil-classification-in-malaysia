# -*- coding: utf-8 -*-
"""
Created on Sun Jun 16 17:23:34 2024
...
# Dynamically update soil classification options based on the selected locations
available_classifications = filtered_data['USCS Classification'].unique()
classification_filter = st.sidebar.multiselect("Select Soil Classification(s)", available_classifications)

# Further filter data based on soil classification selection
